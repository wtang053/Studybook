...
public class SwingUtil {
    public static final String SERVER_URL = "http://3.14.88.111:8080/";
    ...
    public static ActionResult getFromPost(String url, HashMap<String, String> parameters) throws Exception {
        ...
        Gson g = new Gson();
        return g.fromJson(response.toString().replace(", ", ",").replace(" ", "　"), ActionResult.class);
    }
}
